...
In order to prove whether out initial hypothesis holds, we first look at the bandwidth estimate distributions for Reno with and without NewCWV (Figures \ref{fig:avg-bitrate-clients-1} - \ref{fig:avg-bitrate-clients-5}). This allows us to verify whether New CWV enabled connections obtain more consistent bandwidth estimate. This shows the transport layer impact of New CWV's congestion window after idle resumption. 
