...
\todo{Can include data for average number of lost packets per connection to provide more transport descriptive metrics.}
  ...
  \begin{figure*}
    \centering
    \subfloat[1 Client]{
      \includegraphics[width=\textwidth, height=.18\paperheight, keepaspectratio]{figures/Throughput_1_clients.pdf}
      \label{fig:throughput-clients-1}
    }
    \\
    \subfloat[2 Clients]{
      \includegraphics[width=\textwidth, height=.18\paperheight, keepaspectratio]{figures/Throughput_2_clients.pdf}
      \label{fig:throughput-clients-2}
    }
    \\
    \subfloat[3 Clients]{
      \includegraphics[width=\textwidth, height=.18\paperheight, keepaspectratio]{figures/Throughput_3_clients.pdf}
      \label{fig:throughput-clients-3}
    }
    \\
    \subfloat[5 Clients]{
      \includegraphics[width=\textwidth, height=.18\paperheight, keepaspectratio]{figures/Throughput_5_clients.pdf}
...
\begin{figure*}
    ...
    \\
    \subfloat[Average Osillations]{
      \includegraphics[width=\textwidth, height=.25\paperheight, keepaspectratio]{figures/Average_Oscillations.pdf}
      \label{...}
    }
    \\
    \subfloat[Rebuffer Ratio]{
      \includegraphics[width=\textwidth, height=.25\paperheight, keepaspectratio]{figures/Rebuffer_ratio.pdf}
      \label{...}
    }
    \caption{QoE Metrics}
    \label{...}
