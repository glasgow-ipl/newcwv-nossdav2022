...
The impact of this concept is shown on Figure~\ref{fig:transmission-after-idle}. In it, New CWV uses previously set ssthresh value and leaves slow-start early. This results in New CWV connections not experiencing any packet loss (Figure~\ref{fig:transmission-after-idle-newcwv}), after reaching their set ssthresh value in the third burst. In contrast, if the same connection used CWV, the senders would not have a set ssthresh value and would see more packet loss as they were sending faster than was capable of carrying, forth burst and end of third (Figure~\ref{fig:transmission-after-idle-reno}). Overall, New CWV results in fewer lost packets, and a more consistent and predictable sending rate.
